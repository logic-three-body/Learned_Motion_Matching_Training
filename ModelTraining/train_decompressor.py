...
from train_common import load_database, load_features, save_onnx_network
...
if __name__ == '__main__':
    ...
    database = load_database('./Database/database.bin')
    ...
    X = load_features('./Database/features.bin')['features'].astype(np.float32)
    ...
    def save_compressed_database():
        ...
        with torch.no_grad():
            ...
            with open('./Database/latent.bin', 'wb') as f:
    ...
    def generate_animation():
        ...
        with torch.no_grad():
            ...
            try:
                bvh.save('./Misc/decompressor_Ygnd.bvh', {
                ...
                bvh.save('./Misc/decompressor_Ytil.bvh', {
            ...
            try:
                plt.savefig('./Misc/decompressor_X.png')
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig('./Misc/decompressor_Z.png')
            except IOError as e:
                print(e)

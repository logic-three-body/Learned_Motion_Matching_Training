...
from train_common import load_database, load_features, load_latent, save_onnx_network
...
if __name__ == '__main__':
    ...
    X = load_features('./Database/features.bin')['features'].copy().astype(np.float32)
    Z = load_latent('./Database/latent.bin')['latent'].copy().astype(np.float32)
    ...
    def generate_predictions():
        ...
        with torch.no_grad():
            ...
            try:
                plt.savefig('./Misc/projector_X.png')
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig('./Misc/projector_Z.png')
            except IOError as e:
                print(e)
